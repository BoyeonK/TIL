...
PROTOBUF_NAMESPACE_OPEN
template<> ::PB::C_CHAT* Arena::CreateMaybeMessage<::PB::C_CHAT>(Arena*);
template<> ::PB::S_CHAT* Arena::CreateMaybeMessage<::PB::S_CHAT>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace PB {
...
class C_CHAT final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PB.C_CHAT) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:PB.C_CHAT)
 private:
  class _Internal;
...
class S_CHAT final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PB.S_CHAT) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:PB.S_CHAT)
 private:
  class _Internal;
...
inline const std::string& C_CHAT::msg() const {
  // @@protoc_insertion_point(field_get:PB.C_CHAT.msg)
...
void C_CHAT::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:PB.C_CHAT.msg)
}
inline std::string* C_CHAT::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:PB.C_CHAT.msg)
  return _s;
}
...
inline std::string* C_CHAT::release_msg() {
  // @@protoc_insertion_point(field_release:PB.C_CHAT.msg)
...
inline void C_CHAT::set_allocated_msg(std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PB.C_CHAT.msg)
}
...
inline uint64_t S_CHAT::playerid() const {
  // @@protoc_insertion_point(field_get:PB.S_CHAT.playerId)
...
inline void S_CHAT::set_playerid(uint64_t value) {
  ...
  // @@protoc_insertion_point(field_set:PB.S_CHAT.playerId)
}
...
inline const std::string& S_CHAT::msg() const {
  // @@protoc_insertion_point(field_get:PB.S_CHAT.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void S_CHAT::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:PB.S_CHAT.msg)
}
inline std::string* S_CHAT::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:PB.S_CHAT.msg)
  return _s;
}
...
inline std::string* S_CHAT::release_msg() {
  // @@protoc_insertion_point(field_release:PB.S_CHAT.msg)
  return _impl_.msg_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:PB.S_CHAT.msg)
}
